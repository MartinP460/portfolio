            ...
            <ul className="mt-4 flex flex-col gap-2">
              {skill.items.map((item) => (
                <li
                  key={item}
                  data-icon="&#9660;"
                  className="before:content-[attr(data-icon)] before:block before:-rotate-90 before:absolute before:text-sm before:text-primary-800 dark:before:text-gray-400"
                >
