const Header = () => {
  return (
    <header className="flex flex-col justify-center min-h-screen">
      <p className="font-semibold bg-clip-text text-transparent bg-gradient-to-br from-primary-800 to-primary-200">
        Hey - I&apos;m
      </p>
      <h1 className="font-bold text-7xl mt-3">Martin Polley.</h1>
      <h2 className="font-bold text-7xl text-gray-600 mt-4">
        I build cool software.
      </h2>
      <p className="text-gray-600 mt-8 max-w-lg">
      ...
      <button className="border-2">Projects</button>
    </header>
  )
}
